...
const Login = (props) => {
  ...
  // the cleanup never takes effect in the first time
  // if there is no dependencies, then when it is removed
  // if there is, then everytime except for the first time
  useEffect(() => {
    console.log('running');
